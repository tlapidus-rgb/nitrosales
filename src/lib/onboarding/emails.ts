...
// Primitivas de marca/layout movidas a ./email-theme (Fase 1.5 S4) para romper el
// ciclo emails ⇄ template-renderer. Se importan para uso interno y se re-exportan
// para compat (10 rutas importan estos símbolos desde onboarding/emails).
import {
  BRAND_BG,
  CARD_BG,
  BRAND_ORANGE,
