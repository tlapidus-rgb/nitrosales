...
export const SOURCE_GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  facebook: { label: "Facebook", tip: "Visita que llegó desde Facebook (un posteo, una página o un mensaje)." },
  fb: { label: "Facebook", tip: "Visita que llegó desde Facebook. «fb» es el código que usa Meta para el feed de Facebook." },
  instagram: { label: "Instagram", tip: "Visita que llegó desde Instagram (un posteo, una historia o el link de la biografía)." },
  ig: { label: "Instagram", tip: "Visita que llegó desde Instagram. «ig» es el código que usa Meta para Instagram." },
  ...
  // Otras plataformas
  tiktok: { label: "TikTok", tip: "Visita que llegó desde TikTok. Puede ser paga (anuncio) u orgánica (un video) según cómo llegó." },
  bing: { label: "Bing (Microsoft)", tip: "Visita que llegó desde Bing, el buscador de Microsoft." },
  bing_organic: { label: "Bing (búsqueda)", tip: "Búsqueda orgánica (gratis) en Bing — te encontraron buscando." },
  microsoft: { label: "Microsoft Ads", tip: "Anuncios pagos en Bing (Microsoft)." },
  youtube: { label: "YouTube", tip: "Visita que llegó desde YouTube (un video o su descripción)." },
  whatsapp: { label: "WhatsApp", tip: "Visita que llegó desde WhatsApp (un mensaje o un enlace compartido)." },
  linkedin: { label: "LinkedIn", tip: "Visita que llegó desde LinkedIn." },
  twitter: { label: "X (Twitter)", tip: "Visita que llegó desde X (antes Twitter)." },
  pinterest: { label: "Pinterest", tip: "Visita que llegó desde Pinterest." },
