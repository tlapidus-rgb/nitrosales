...
// proceso de la compra". Un PAGE_VIEW cuenta como visita SALVO que sea parte del
// embudo de compra.
//
// ⚠️ SÓLO afecta contadores de VISITA (page_views, pv_visitors, device, source,
// etapa PV del funnel). NO toca las etapas product/cart/checkout/purchase: esas
// TIENEN que ver los checkouts, son lo que miden. Un `pageUrl` NULL SÍ cuenta
// (visita sin URL registrada, no un checkout). `pe.` = alias del backfill
// por-día; _NOALIAS = query de agregados sin alias.
