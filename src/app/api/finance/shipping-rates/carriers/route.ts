 ...
 *
 * Returns distinct shipping carrier + service combinations from order data.
 * Shipping data was populated from VTEX CSV exports (SLA Type + Courrier fields).
 * v3 — simplified: reads only from DB (already populated with correct data).
 */
