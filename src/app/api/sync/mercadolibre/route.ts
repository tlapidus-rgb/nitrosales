  ...
  try {
    ...
    try {
      ...
      for (const order of mlOrders) {
        ...
        // Tanda 7.10.4 — capturar promociones ML. ML expone promociones a nivel
        // orden (order.promotions) y/o a nivel item (item.promotion). Unimos
        // los nombres únicos en un string separado por coma, igual que VTEX.
