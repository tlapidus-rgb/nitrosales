...
// Chrome neutro (ink) — el tipo de campaña se distingue por ícono + label, no por
// una paleta arcoíris (ver receta: "badges de icono en CHROME → ink/neutral").
...
function StatusDot({ status }: { status: string }) {
  ...
  const cfg =
    s === "ACTIVE" || s === "ENABLED"
      ...
      ? { bg: "bg-ink-40", label: "Eliminada", ring: "ring-hairline" }
      : { bg: "bg-ink-40", label: s || "—", ring: "ring-hairline" };
  return (
...
function classifyCampaign(c: {
  ...
  if (c.daysWithData > 0 && c.daysWithData <= 3 && c.conversions < 5) {
    return { label: "En aprendizaje", kind: "learn", Icon: Hourglass, soft: "bg-surface-2", text: "text-ink-60" };
  }
    ...
    <div className="w-full">
      <div className="flex items-center justify-between mb-1">
        ...
        <span className="text-[13px] font-bold tabular-nums" style={{ color }}>
          ...
          <span className="text-[10px] text-ink-40 font-medium ml-0.5">/10</span>
        </span>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto p-5 lg:p-8 space-y-6">
        ...
        >
          <div>
            <div className="text-xs text-ink-40 tracking-tight flex items-center gap-1.5">
              ...
              <span className="text-ink-60 font-medium">Google Ads</span>
            </div>
        ...
        {hasPMax && (
          ...
          >
            ...
            />
            <div className="relative bg-elevated/80 backdrop-blur p-5 lg:p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-semibold text-amber-700 bg-elevated px-2.5 py-1 rounded-lg ring-1 ring-amber-200 hover:ring-amber-300"
              ...
              <div className="mt-4 text-[11px] text-ink-40 italic flex items-start gap-1.5">
        ...
        >
          <div className="flex items-center justify-between mb-5">
            <div>
              <h2 className="text-sm font-semibold text-ink tracking-tight flex items-center gap-2">
                <PieIcon size={15} className="text-ink-40" />
              ...
              {visibleTypes.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left rounded-2xl p-4 lg:p-5 bg-elevated ring-1 relative overflow-hidden ${
                      typeFilter === t.key ? "ring-hairline-2" : "ring-hairline hover:ring-hairline"
                    }`}
                    style={{
                      boxShadow:
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="text-[11px] text-ink-40 mt-0.5">{t.sublabel}</div>
                      </div>

                      <div className="mt-3">
                        <div className="text-xl font-bold text-ink tabular-nums tracking-tight">
                          {formatARS(v.spend)}
                        </div>
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <div>
                          <div className="text-[10px] font-semibold uppercase tracking-widest text-ink-40">ROAS</div>
                          <div
                        ...
                        <div className="text-right">
                          <div className="text-[10px] font-semibold uppercase tracking-widest text-ink-40">Conv.</div>
        ...
        >
          <div className="p-4 lg:p-5 border-b border-hairline flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="relative">
                <SearchIcon size={13} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-ink-40" />
                <input
                  type="text"
                  value={query}
                  onChange={(e) => setQuery(e.target.value)}
                  placeholder="Buscar campaña…"
                  className="pl-8 pr-3 py-1.5 text-xs border border-hairline rounded-lg w-52 focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/30 tracking-tight"
                  style={{
              ...
              <div className="inline-flex rounded-lg bg-surface-2 p-0.5 flex-wrap">
                        ...
                        >
                          <td className="py-3 px-4 lg:px-6">
                            <div className="flex items-center gap-2">
                              {isPMax ? (
                                <span className="p-0.5 w-5 h-5 flex items-center justify-center text-ink-40">
                                  <Zap size={12} />
                                </span>
                              ) : (
                                <button
                          ...
                          <tr className="bg-surface/70 border-b border-hairline">
                            <td colSpan={10} className="p-4 lg:p-5">
                              {structureLoading && adsets.length === 0 ? (
                                <div className="text-[11px] text-ink-40">Cargando ad groups…</div>
                              ) : adsets.length === 0 ? (
                                <div className="text-[11px] text-ink-40">Sin ad groups en este período.</div>
                              ) : (
...
function PMaxStat({
  ...
  return (
    <div className="rounded-xl bg-elevated/70 p-3 border border-amber-100/80">
      <div className="text-[10px] font-semibold uppercase tracking-widest text-ink-40">{label}</div>
      <div className={`text-[17px] font-bold tabular-nums tracking-tight mt-0.5 ${valueClass || "text-ink"}`}>
        {value}
      </div>
    </div>
  );
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {onClick && (
              <ChevronRight size={13} className="text-ink-40 group-hover:text-ink-40 ml-auto" />
            )}
          </div>
      ...
      >
        ...
        {showQSIS && (campaign.qualityScore != null || campaign.impressionShare != null) && (
          <div className="px-5 pb-2">
            <h4 className="text-[12px] font-semibold uppercase tracking-widest text-ink-40 mb-3">
              Señales Google
            </h4>
            <div className="rounded-xl bg-surface/60 p-4 border border-hairline space-y-4">
        ...
        {!isPMax && (
          <div className="px-5 pt-3 pb-6">
            ...
            {loadingStructure && adsets.length === 0 ? (
              <div className="text-[12px] text-ink-40">Cargando ad groups…</div>
            ) : adsets.length === 0 ? (
              ...
              <div className="space-y-2">
                {adsets
                  ...
                  .sort((a: any, b: any) => (b.spend || 0) - (a.spend || 0))
                  .map((a: any) => (
                    <div key={a.id} className="rounded-xl border border-hairline p-3 bg-surface/40">
        ...
        <div className="px-5 pb-6">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-[12px] font-semibold text-ink hover:text-ink-60"
