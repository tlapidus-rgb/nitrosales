...
function ChannelLogo({ source, size = 14 }: { source?: string; size?: number }) {
  ...
  switch (s) {
    case "meta":
      // Meta company logo — el "infinito" estilizado (loop horizontal)
    ...
    case "facebook":
      // Facebook clasico — F blanca centrada
      return (<svg {...props}><path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01z"/></svg>);
    case "instagram":
    ...
    <div className={`min-h-screen bg-gradient-to-b from-white via-[#fbfbfd] to-[#f4f5f8] ${isRefetching ? "pixel-refetching" : ""}`}>
      ...
      <div className="max-w-[1440px] mx-auto px-6 py-6 space-y-6">
        ...
        {(() => {
          ...
          // CR por Categoría / Marca / Producto se movieron a /products (tab "Conversión") — Sesión 20
