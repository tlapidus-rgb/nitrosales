...
export default function AudienceSyncPage() {
  ...
  const statusBadge = (s: string) => {
    const map: Record<string, { color: string; label: string }> = {
      ...
      DRAFT: { color: "rgb(var(--ent-ink-60))", label: "Borrador" },
      PAUSED: { color: "#eab308", label: "Pausada" },
      ERROR: { color: "#ef4444", label: "Error" },
    };
    return map[s] || { color: "rgb(var(--ent-ink-60))", label: s };
  };
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      <div className="relative rounded-2xl overflow-hidden bg-surface border border-hairline">
        {/* Animated grid pattern */}
        <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "transparent", backgroundSize: "24px 24px" }} />

        <div className="relative px-8 py-8">
          <div className="flex items-start justify-between">
            <div className="max-w-2xl">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "rgb(var(--ent-ink))" }}>
                ...
                <div>
                  <h1 className="text-2xl font-bold text-ink">Audience Sync</h1>
                  <span className="px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-widest" style={{ background: "rgb(var(--ent-hairline-2))", color: "rgb(var(--ent-ink-40))", border: "1px solid rgb(var(--ent-hairline-2))" }}>SYNC</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-[11px] flex-wrap">
                <span className="px-2.5 py-1 rounded-lg font-semibold" style={{ background: "rgb(var(--ent-hairline-2))", color: "#6d28d9", border: "1px solid rgb(var(--ent-hairline-2))" }}>
                  Tus clientes en NitroSales
                </span>
                <svg className="w-4 h-4" style={{ color: "#83807A" }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
                <span className="px-2.5 py-1 rounded-lg font-semibold" style={{ background: "rgb(var(--ent-hairline-2))", color: "rgb(var(--ent-ink-40))", border: "1px solid rgb(var(--ent-hairline-2))" }}>
            ...
            <button
              ...
              style={{ background: builderStep > 0 ? "rgba(107,114,128,0.1)" : "rgb(var(--ent-ink))", color: builderStep > 0 ? "rgb(var(--ent-ink-60))" : "#fff", boxShadow: builderStep > 0 ? "none" : "0 4px 20px rgb(var(--ent-hairline-2))" }}
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="rounded-xl p-5 relative overflow-hidden group hover:border-opacity-30 transition-all bg-elevated" style={{ border: `1px solid ${step.color}25` }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs leading-relaxed text-ink-60">{step.desc}</p>
          ...
          <div className="text-center pt-4">
            <button
              ...
              style={{ background: "rgb(var(--ent-ink))", color: "#fff", boxShadow: "0 4px 20px rgb(var(--ent-hairline-2))" }}
            >
              Crear mi primera audiencia
            </button>
            <p className="text-xs mt-2 text-ink-60">No se envia nada hasta que vos lo actives</p>
          </div>
        </div>
      )}
      ...
      {summary && audiences.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: "Audiencias creadas", value: summary.totalAudiences, sub: `${summary.activeAudiences} activas`, color: "#83807A" },
            ...
            <div key={i} className="rounded-xl p-4 relative overflow-hidden group bg-elevated" style={{ border: `1px solid ${card.color}20` }}>
              <div className="absolute top-0 left-0 w-full h-[1px]" style={{ background: `linear-gradient(90deg, ${card.color}60, transparent)` }} />
              <p className="text-[10px] uppercase tracking-wider font-medium text-ink-60">{card.label}</p>
      ...
      {/* ═══════════════════════════════════════════
          ...
          ═══════════════════════════════════════════ */}
      {builderStep >= 1 && (
        <div className="rounded-2xl overflow-hidden bg-elevated border border-hairline">
            ...
            {[
              ...
              <button key={s.n} onClick={() => setBuilderStep(s.n)} className="flex items-center gap-2 group">
                <div
                  ...
                  style={{
                    background: builderStep >= s.n ? "rgb(var(--ent-ink))" : "rgba(107,114,128,0.1)",
                    color: builderStep >= s.n ? "#fff" : "rgb(var(--ent-ink-60))",
                  }}
                >
                  {builderStep > s.n ? "✓" : s.n}
                </div>
                <span className="text-xs font-medium transition-colors" style={{ color: builderStep >= s.n ? "rgb(var(--ent-ink))" : "rgb(var(--ent-ink-40))" }}>{s.label}</span>
                {s.n < 3 && <div className="w-12 h-[1px] ml-2" style={{ background: builderStep > s.n ? "#83807A" : "rgba(0,0,0,0.1)" }} />}
              </button>
            ))}
          </div>
          ...
          <div className="px-6 pb-6 space-y-5">
            ...
            {builderStep === 1 && (
              <div className="space-y-5">
                <div>
                  <h3 className="text-base font-semibold mb-1 text-ink">Que clientes queres enviar?</h3>
                  <p className="text-xs text-ink-60">NitroSales clasifica automaticamente a tus clientes segun como compran. Elegi que grupo queres sincronizar con tus plataformas de publicidad.</p>
                </div>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <button
                      ...
                      style={{
                        background: builderSegmentType === t.id ? "rgb(var(--ent-hairline-2))" : "rgb(var(--ent-surface))",
                        border: builderSegmentType === t.id ? "1px solid rgb(var(--ent-hairline-2))" : "1px solid rgba(0,0,0,0.08)",
                      }}
                    >
                      <div className="text-xl mb-2">{t.icon}</div>
                      <p className="text-sm font-semibold" style={{ color: builderSegmentType === t.id ? "rgb(var(--ent-ink-40))" : "rgb(var(--ent-ink-60))" }}>{t.label}</p>
                      <p className="text-[10px] mt-0.5 text-ink-60">{t.desc}</p>
                    </button>
                  ))}
                </div>
                ...
                {builderSegmentType === "RFM" && (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <p className="text-xs text-ink-60">Selecciona los segmentos que queres incluir en esta audiencia:</p>
                      <p className="text-[10px] font-mono text-ink-60">{builderRfmSegments.length} seleccionados</p>
                    </div>
                      ...
                      {RFM_SEGMENTS.map((seg) => {
                        ...
                        return (
                          <button
                            ...
                            style={{
                              background: sel ? `${seg.color}0a` : "rgb(var(--ent-surface))",
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-semibold" style={{ color: sel ? seg.color : "rgb(var(--ent-ink-60))" }}>{seg.label}</span>
                                </div>
                                <p className="text-xs mt-0.5 text-ink-60">{seg.desc}</p>
                                {/* Expanded detail on hover or selection */}
                                {(sel || hovered) && (
                                  <div className="mt-2 space-y-1.5">
                                    <p className="text-[11px] leading-relaxed text-ink-60">{seg.detail}</p>
                ...
                {builderSegmentType === "LTV" && (
                  <div className="space-y-3">
                    <p className="text-xs text-ink-60">NitroSales predice cuanto va a gastar cada cliente en el proximo ano usando inteligencia artificial. Selecciona que nivel de valor queres enviar:</p>
                      ...
                      {LTV_BUCKETS.map((b) => {
                        ...
                        return (
                          <button
                            ...
                            style={{
                              background: sel ? `${b.color}0a` : "rgb(var(--ent-elevated))",
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-sm font-semibold" style={{ color: sel ? b.color : "rgb(var(--ent-ink-60))" }}>{b.label}</span>
                            </div>
                            <p className="text-[11px] leading-relaxed" style={{ color: "rgb(var(--ent-ink-60))" }}>{b.detail}</p>
                ...
                {builderSegmentType === "ALL_CUSTOMERS" && (
                  <div className="rounded-xl p-4" style={{ background: "rgba(59,130,246,0.06)", border: "1px solid rgba(59,130,246,0.15)" }}>
                    <p className="text-sm" style={{ color: "rgb(var(--ent-ink-60))" }}>Se enviaran <strong style={{ color: "rgb(var(--ent-ink))" }}>todos tus clientes que tengan email</strong> (al menos 1 compra registrada). Esto es util para crear una audiencia de exclusion (no mostrar ads a gente que ya compro) o un Lookalike amplio.</p>
                  </div>
                )}
                ...
                {builderSegmentType !== "ALL_CUSTOMERS" && (
                  <div>
                    <p className="text-xs mb-3" style={{ color: "rgb(var(--ent-ink-60))" }}>Filtros adicionales (opcional) — para refinar mas tu audiencia:</p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      <div>
                        <label className="text-[10px] block mb-1" style={{ color: "rgb(var(--ent-ink-60))" }}>Minimo de compras</label>
                        <input type="number" value={builderMinOrders} onChange={(e) => setBuilderMinOrders(e.target.value)} placeholder="Ej: 2" className="w-full px-3 py-2 rounded-lg text-sm" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.12)", color: "rgb(var(--ent-ink))" }} />
                        <p className="text-[9px] mt-1" style={{ color: "rgb(var(--ent-ink-40))" }}>Solo clientes con X o mas ordenes</p>
                      </div>
                      <div>
                        <label className="text-[10px] block mb-1" style={{ color: "rgb(var(--ent-ink-60))" }}>Gasto minimo (ARS)</label>
                        <input type="number" value={builderMinSpent} onChange={(e) => setBuilderMinSpent(e.target.value)} placeholder="Ej: 50000" className="w-full px-3 py-2 rounded-lg text-sm" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.12)", color: "rgb(var(--ent-ink))" }} />
                        <p className="text-[9px] mt-1" style={{ color: "rgb(var(--ent-ink-40))" }}>Solo clientes que gastaron mas de $X total</p>
                      </div>
                      <div>
                        <label className="text-[10px] block mb-1" style={{ color: "rgb(var(--ent-ink-60))" }}>Ultima compra (max dias)</label>
                        <input type="number" value={builderRecencyMax} onChange={(e) => setBuilderRecencyMax(e.target.value)} placeholder="Ej: 90" className="w-full px-3 py-2 rounded-lg text-sm" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.12)", color: "rgb(var(--ent-ink))" }} />
                        <p className="text-[9px] mt-1" style={{ color: "rgb(var(--ent-ink-40))" }}>Solo clientes que compraron en los ultimos X dias</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {/* Live preview panel */}
                {preview && (
                  <div className="rounded-xl p-4" style={{ background: "rgb(var(--ent-hairline-2))", border: "1px solid rgb(var(--ent-hairline-2))" }}>
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                        <span className="text-xs font-semibold" style={{ color: "rgb(var(--ent-ink))" }}>Vista previa en tiempo real</span>
                      </div>
                      {previewLoading && <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-40))" }}>Calculando...</span>}
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div>
                        <p className="text-2xl font-bold" style={{ color: "rgb(var(--ent-ink))" }}>{preview.totalCustomers.toLocaleString()}</p>
                        <p className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>clientes en esta audiencia</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold" style={{ color: "rgb(var(--ent-ink))" }}>{preview.withEmail.toLocaleString()}</p>
                        <p className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>con email (enviables)</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold" style={{ color: "#1d4ed8" }}>~{preview.estimatedMetaMatch.toLocaleString()}</p>
                        <p className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>estimado match en Meta</p>
                      </div>
                      <div>
                        <p className="text-2xl font-bold" style={{ color: "#1a73e8" }}>~{preview.estimatedGoogleMatch.toLocaleString()}</p>
                        <p className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>estimado match en Google</p>
                      </div>
                    </div>
                    {Object.keys(preview.segmentBreakdown).length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-3 pt-3" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                        {Object.entries(preview.segmentBreakdown).map(([seg, count]) => {
                          ...
                          return (
                            <span key={seg} className="px-2 py-0.5 rounded text-[10px] font-medium" style={{ background: `${def?.color || "rgb(var(--ent-ink-60))"}12`, color: def?.color || "rgb(var(--ent-ink-60))", border: `1px solid ${def?.color || "rgb(var(--ent-ink-60))"}25` }}>
                              {seg}: {count}
                            </span>
                          );
                        })}
                    ...
                    <p className="text-[9px] mt-2" style={{ color: "rgb(var(--ent-ink-40))" }}>Match = cuantos emails Meta/Google logra cruzar con cuentas reales. Mas datos (nombre, ciudad) = mejor match rate.</p>
                  </div>
                )}

                <div className="flex justify-end">
                  <button onClick={() => setBuilderStep(2)} className="px-5 py-2 rounded-xl text-sm font-semibold transition-all hover:scale-[1.02]" style={{ background: "rgb(var(--ent-ink))", color: "#fff" }}>
            ...
            {builderStep === 2 && (
              <div className="space-y-5">
                <div>
                  <h3 className="text-base font-semibold mb-1" style={{ color: "rgb(var(--ent-ink))" }}>A donde queres enviar esta audiencia?</h3>
                  <p className="text-xs" style={{ color: "rgb(var(--ent-ink-60))" }}>La audiencia va a aparecer como &quot;Custom Audience&quot; en Meta Ads Manager o como &quot;Customer List&quot; en Google Ads, lista para usar en tus campanas.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <button
                      ...
                      style={{
                        background: builderPlatform === p.id ? `${p.color}0a` : "rgb(var(--ent-elevated))",
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold" style={{ color: builderPlatform === p.id ? p.color : "rgb(var(--ent-ink-60))" }}>{p.name}</span>
                      ...
                      <p className="text-[11px] mb-3" style={{ color: "rgb(var(--ent-ink-60))" }}>{p.desc}</p>
                      <ul className="space-y-1.5">
                        {p.features.map((f, fi) => (
                          <li key={fi} className="flex items-start gap-1.5 text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>
                ...
                <div className="flex justify-between">
                  <button onClick={() => setBuilderStep(1)} className="text-sm transition-colors" style={{ color: "rgb(var(--ent-ink-60))" }}>← Volver</button>
                  <button onClick={() => setBuilderStep(3)} className="px-5 py-2 rounded-xl text-sm font-semibold transition-all hover:scale-[1.02]" style={{ background: "rgb(var(--ent-ink))", color: "#fff" }}>
            ...
            {builderStep === 3 && (
              <div className="space-y-5">
                <div>
                  <h3 className="text-base font-semibold mb-1" style={{ color: "rgb(var(--ent-ink))" }}>Ponele nombre y configura la sincronizacion</h3>
                  <p className="text-xs" style={{ color: "rgb(var(--ent-ink-60))" }}>Este nombre va a aparecer en Meta Ads Manager / Google Ads como el nombre de la audiencia.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-[10px] block mb-1" style={{ color: "rgb(var(--ent-ink-60))" }}>Nombre de la audiencia *</label>
                    <input type="text" value={builderName} onChange={(e) => setBuilderName(e.target.value)} placeholder="Ej: Champions para Lookalike" className="w-full px-4 py-2.5 rounded-xl text-sm font-medium" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.12)", color: "rgb(var(--ent-ink))" }} />
                    <p className="text-[9px] mt-1" style={{ color: "rgb(var(--ent-ink-40))" }}>Tip: usa un nombre descriptivo. Va a aparecer asi en Meta/Google.</p>
                  </div>
                  <div>
                    <label className="text-[10px] block mb-1" style={{ color: "rgb(var(--ent-ink-60))" }}>Descripcion (opcional)</label>
                    <input type="text" value={builderDesc} onChange={(e) => setBuilderDesc(e.target.value)} placeholder="Ej: Top clientes para lookalike 1%" className="w-full px-4 py-2.5 rounded-xl text-sm" style={{ background: "rgba(255,255,255,0.8)", border: "1px solid rgba(0,0,0,0.12)", color: "rgb(var(--ent-ink))" }} />
                  </div>
                </div>

                {/* Auto sync */}
                <div className="rounded-xl p-4" style={{ background: "rgb(var(--ent-elevated))",  border: "1px solid rgba(0,0,0,0.08)" }}>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium" style={{ color: "rgb(var(--ent-ink))" }}>Sincronizacion automatica</p>
                      <p className="text-[10px] mt-0.5" style={{ color: "rgb(var(--ent-ink-60))" }}>Si lo activas, NitroSales actualiza la audiencia automaticamente segun la frecuencia que elijas. Los clientes nuevos se agregan y los que ya no cumplen los criterios se quitan.</p>
                    </div>
                    <button onClick={() => setBuilderAutoSync(!builderAutoSync)} className="w-11 h-6 rounded-full transition-all relative flex-shrink-0" style={{ background: builderAutoSync ? "rgb(var(--ent-ink))" : "rgba(0,0,0,0.1)" }}>
                  ...
                  {builderAutoSync && (
                    <div className="mt-3 pt-3 flex gap-2" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                      {[
                        ...
                        <button key={f.id} onClick={() => setBuilderSyncFreq(f.id)} className="flex-1 p-2.5 rounded-lg text-center transition-all" style={{ background: builderSyncFreq === f.id ? "rgb(var(--ent-hairline-2))" : "rgb(var(--ent-elevated))", border: builderSyncFreq === f.id ? "1px solid rgb(var(--ent-hairline-2))" : "1px solid rgba(0,0,0,0.06)" }}>
                          <p className="text-xs font-medium" style={{ color: builderSyncFreq === f.id ? "rgb(var(--ent-ink-40))" : "rgb(var(--ent-ink-60))" }}>{f.label}</p>
                          <p className="text-[9px]" style={{ color: "rgb(var(--ent-ink-40))" }}>{f.desc}</p>
                        </button>
                      ))}
                    </div>
                  )}
                ...
                <div className="rounded-xl p-4" style={{ background: "rgba(34,197,94,0.05)", border: "1px solid rgba(34,197,94,0.15)" }}>
                  <p className="text-xs font-semibold mb-2" style={{ color: "rgb(var(--ent-ink))" }}>Resumen de la audiencia</p>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div><span style={{ color: "rgb(var(--ent-ink-60))" }}>Clientes:</span> <span className="font-medium" style={{ color: "rgb(var(--ent-ink))" }}>{preview?.totalCustomers.toLocaleString() || "..."}</span></div>
                    <div><span style={{ color: "rgb(var(--ent-ink-60))" }}>Tipo:</span> <span className="font-medium" style={{ color: "rgb(var(--ent-ink))" }}>{builderSegmentType === "RFM" ? "Comportamiento" : builderSegmentType === "LTV" ? "Valor predicho" : "Todos"}</span></div>
                    <div><span style={{ color: "rgb(var(--ent-ink-60))" }}>Destino:</span> <span className="font-medium" style={{ color: "rgb(var(--ent-ink))" }}>{builderPlatform === "META" ? "Meta Ads" : builderPlatform === "GOOGLE" ? "Google Ads" : "Meta + Google"}</span></div>
                    <div><span style={{ color: "rgb(var(--ent-ink-60))" }}>Auto-sync:</span> <span className="font-medium" style={{ color: "rgb(var(--ent-ink))" }}>{builderAutoSync ? builderSyncFreq.toLowerCase() : "Manual"}</span></div>
                  </div>
                </div>

                <div className="flex justify-between items-center">
                  <button onClick={() => setBuilderStep(2)} className="text-sm transition-colors" style={{ color: "rgb(var(--ent-ink-60))" }}>← Volver</button>
                  <div className="flex gap-3">
                    <button onClick={() => { setBuilderStep(0); resetBuilder(); }} className="px-4 py-2 rounded-xl text-sm transition-colors" style={{ color: "rgb(var(--ent-ink-60))" }}>Cancelar</button>
                    <button onClick={saveAudience} disabled={!builderName.trim() || saving} className="px-6 py-2.5 rounded-xl text-sm font-semibold transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-40 disabled:hover:scale-100" style={{ background: "rgb(var(--ent-ink))", color: "#fff", boxShadow: "0 4px 20px rgb(var(--ent-hairline-2))" }}>
                      {saving ? (
      ...
      {audiences.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold" style={{ color: "rgb(var(--ent-ink))" }}>Tus audiencias</h2>
          {audiences.map((a) => {
            const badge = statusBadge(a.status);
            const isSyncing = syncing === a.id || a.status === "SYNCING";
            return (
              <div key={a.id} className="rounded-xl overflow-hidden transition-all group" style={{ background: "rgb(var(--ent-elevated))",  border: "1px solid rgba(0,0,0,0.08)" }}>
                <div className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2.5 flex-wrap">
                        <h3 className="text-sm font-semibold" style={{ color: "rgb(var(--ent-ink))" }}>{a.name}</h3>
                        ...
                        <span className="px-2 py-0.5 rounded-md text-[9px] font-medium uppercase" style={{ background: "rgba(0,0,0,0.04)", color: "rgb(var(--ent-ink-60))" }}>
                          {a.platform === "META" ? "Meta Ads" : a.platform === "GOOGLE" ? "Google Ads" : "Meta + Google"}
                        </span>
                        {a.autoSync && (
                          <span className="px-2 py-0.5 rounded-md text-[9px] font-medium" style={{ background: "rgb(var(--ent-hairline-2))", color: "rgb(var(--ent-ink-40))" }}>
                            Auto-sync {a.syncFrequency.toLowerCase()}
                          </span>
                        )}
                      </div>
                      {a.description && <p className="text-xs mt-1" style={{ color: "rgb(var(--ent-ink-60))" }}>{a.description}</p>}

                      {/* Metrics */}
                      <div className="flex items-center gap-5 mt-3 flex-wrap">
                        <div className="flex items-center gap-1.5">
                          <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#83807A" }} />
                          <span className="text-xs font-medium" style={{ color: "rgb(var(--ent-ink-60))" }}>{a.customerCount.toLocaleString()}</span>
                          <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>clientes</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#3b82f6" }} />
                          <span className="text-xs font-medium" style={{ color: "rgb(var(--ent-ink-60))" }}>{a.lastSyncedCount.toLocaleString()}</span>
                          <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>enviados</span>
                        </div>
                        {a.metaMatchRate !== null && (
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>match Meta</span>
                          </div>
                        )}
                        {a.googleMatchRate !== null && (
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-60))" }}>match Google</span>
                          </div>
                        )}
                        <div className="flex items-center gap-1.5">
                          <span className="text-[10px]" style={{ color: "rgb(var(--ent-ink-40))" }}>Ultimo sync: {formatDate(a.lastSyncAt)}</span>
                        </div>
                      </div>
                      {a.lastSyncError && (
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button
                        ...
                        style={{ background: "rgb(var(--ent-ink))", color: "#fff", boxShadow: "0 2px 12px rgb(var(--ent-hairline-2))" }}
                      >
                        {isSyncing ? (
                      ...
                      <button onClick={() => deleteAudience(a.id)} className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-red-50 transition-all" style={{ color: "rgb(var(--ent-ink-40))" }} title="Eliminar">
