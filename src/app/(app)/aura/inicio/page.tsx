...
> = {
  ...
  no_target: {
    label: "Sin bonus",
    accent: "#83807A",
    bg: "linear-gradient(165deg, rgba(131,128,122,0.05) 0%, rgba(131,128,122,0.01) 100%)",
    border: "rgba(28,27,24,0.06)",
    text: "rgb(var(--ent-ink-60))",
    glow: "rgba(131,128,122,0.2)",
    icon: "no_target",
  },
  no_time_limit: {
    label: "Sin deadline",
...
> = {
  ...
  OTHER: {
    label: "Otro",
    accent: "#83807A",
    bg: "linear-gradient(165deg, rgba(131,128,122,0.08) 0%, rgba(131,128,122,0.02) 100%)",
    border: "rgba(28,27,24,0.06)",
    text: "rgb(var(--ent-ink-60))",
  },
};
