...
export default function ProductsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "trends" | "stock" | "margins">(
  ...
  // Tab "Conversión" movido a /pixel/analytics (feedback 2026-07-15) —
  // ver @/components/pixel/ConversionRateTables.
