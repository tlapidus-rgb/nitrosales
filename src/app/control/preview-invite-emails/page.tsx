...
const VARIANTS = [
  ...
  },
  {
    ...
    tag: "Dolor + urgencia",
    color: "#EF4444",
    angle: "Hook: 40% del presupuesto en ads se pierde. Confrontativo.",
    render: leadInviteVariantA,
  },
  {
    key: "B",
    label: "B — Exclusividad",
    tag: "Status + pertenencia",
    color: "#FF5E1A",
    angle: "Invitación privada. Efecto Superhuman.",
    render: leadInviteVariantB,
  },
  {
    key: "C",
    label: "C — Números concretos",
    tag: "Social proof cuantitativo",
    color: "#22C55E",
    angle: "3 stats gigantes: +32% ROAS, 4x velocidad, -60% tiempo.",
    render: leadInviteVariantC,
  },
  {
    key: "D",
    label: "D — Minimal hero",
    tag: "Un solo punch visual",
    color: "#A855F7",
    angle: "\"Tu ecommerce tiene dos ojos cerrados.\" Vercel/Linear vibe.",
