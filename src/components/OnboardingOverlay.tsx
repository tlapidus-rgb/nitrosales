  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <div style={{ marginTop: 20 }}>
        {platformKey === "VTEX" && <EcommerceInputs creds={creds} onChange={onChange} orgId={orgId} />}
...
function EcommerceInputs({ creds, onChange, orgId }: any) {
    ...
    <>
      ...
      {provider === "vtex" && (
        <div style={{ marginTop: 4 }}>
          ...
          {/* ═════════════════════════════════════════════════════════════════ */}
          {/* PASO ADICIONAL — Afiliado VTEX (manual en VTEX Admin del cliente) */}
          {/* ═════════════════════════════════════════════════════════════════ */}
          <VtexAffiliateOnboardingStep orgId={orgId} />
        </div>
      )}
...
// ══════════════════════════════════════════════════════════════
// Paso del afiliado VTEX (manual del cliente en su VTEX Admin)
// ══════════════════════════════════════════════════════════════
