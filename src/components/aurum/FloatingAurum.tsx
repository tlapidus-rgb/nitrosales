...
const PATHNAME_FALLBACK: Array<{
  ...
  { match: (p) => p.startsWith("/finanzas/pulso"), section: "finanzas.pulso", label: "Finanzas · Pulso", suggestions: ["¿Cómo estoy hoy en una frase?", "¿Qué priorizo esta semana?"] },
  { match: (p) => p.startsWith("/finanzas/estado"), section: "finanzas.estado", label: "Finanzas · Estado", suggestions: ["¿Cómo leo este P&L?", "¿Dónde se está fugando margen?"] },
  ...
  { match: (p) => p.startsWith("/finanzas/fiscal"), section: "finanzas.fiscal", label: "Finanzas · Fiscal", suggestions: ["¿Qué obligación viene primero?", "¿Cómo recupero retenciones?"] },
